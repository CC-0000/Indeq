...
declare module '$env/static/private' {
	...
	export const GOOGLE_SSO_CLIENT_SECRET: string;
	export const GOOGLE_SSO_REDIRECT_URI: string;
	export const GOOGLE_SSO_SCOPES: string;
	export const MICROSOFT_CLIENT_ID: string;
	export const MICROSOFT_CLIENT_SECRET: string;
	export const MICROSOFT_AUTH_URL: string;
	...
	export const NOTION_AUTH_URL: string;
	export const GO_BACKEND_URL: string;
...
declare module '$env/static/public' {
	export const PUBLIC_GO_BACKEND_URL: string;
