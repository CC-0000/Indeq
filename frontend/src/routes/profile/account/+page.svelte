<script lang="ts">
  ...
  // Available models
  const models = [
    { id: 'claude-3', name: 'Claude-3', description: 'Most capable model, best for complex tasks' },
          ...
          <!-- Profile Card -->
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-6">
                ...
                />
                <button class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
                  Upload
                </button>
              </div>
            </div>
        ...
        <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 shadow-sm">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400">Enable markdown formatting in responses</p>
            </div>
            <button
